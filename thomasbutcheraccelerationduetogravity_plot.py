# -*- coding: utf-8 -*-
"""thomasButcherAccelerationDueToGravity_plot.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11yH-BwqB0_PCQIcmLjLTSh_QrDqR9IcM
...
horizontal = np.array([.261, .473, .599, .771, .099])

vertical = np.array([2.29, 4.11, 5.33, 6.69, .817])

uncertainty = np.array([.17, .30, .40, .51, .057])
...
x = horizontal             #this should be the array you want to plot on the x axis
y = vertical             #this should be the array you want to plot on the y axis
dy = uncertainty        #this should be your error in y array


#UPDATE EACH OF THESE 4 STRINGS FOR YOUR PLOT LABELS AS YOU WANT THEM TO APPEAR

plot_title= 'Acceleration Due to Gravity'
x_label= '2*Change in H (m)'
y_label= 'Final Velocity Squared (m^2/s^2)'
slope_units= 'm/s^2'
